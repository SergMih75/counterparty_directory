...
const dataAdd = document.querySelectorAll('.add-data')
...
navBtn.forEach(item => {
	item.addEventListener('click', function (e) {
		...
		if (item.classList.contains('nav__btn-add')) {
			...
			document.getElementById('creation-btn').classList.remove('add-data-disable')
			document.getElementById('edit-btn').classList.add('add-data-disable')
